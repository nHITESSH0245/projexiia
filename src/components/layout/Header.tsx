...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 py-3 px-4 md:px-6 backdrop-blur-lg bg-background/80 border-b border-border transition-all duration-200">
